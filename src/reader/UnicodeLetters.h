/*
 * UnicodeLetters — the non-ASCII code points the lexer accepts in symbols and
 * keywords (Lexer::symbolCharLength): Unicode letters (general categories
 * Lu, Ll, Lt, Lm, Lo), combining marks (Mn, Mc, Me), so that a letter written
 * with a combining accent stays inside its symbol, and decimal digits (Nd).
